...
- [Unfinished Mystery Repository](https://github.com/202304651/UnfinishedMystery)  
...
```bash
git clone https://github.com/202304651/UnfinishedMystery.git
```
...
```text
Assets/
├── Scenes/            # Main game scenes and environments
├── Settings/          # Unity-related settings and configuration assets
├── SourcedAssets/     # Imported external assets and third-party resources
├── TutorialInfo/      # Unity tutorial/import information files
├── audio/             # Background music and sound effects
├── levels/            # Level-specific objects and content
├── materials/         # Materials used for objects and environments
├── prefab/            # Reusable game objects and prefabs
├── scripts/           # C# scripts for gameplay and core systems
